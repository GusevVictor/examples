...
# Решение
s = int(input('Укажите площадь квартиры (метров квадратных): '))
price = int(input('Укажите стоимость квартиры (в млн. руб): '))

if (s >= 100) and (0 <= price <= 10):
  print('Квартира подходит! (Вариант 1)')
elif (s >= 80) and (0 <= price <= 7):
  print('Квартира подходит! (Вариант 2)')
else:
