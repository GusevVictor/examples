...
setats_in_one_row = int(input('Введите кол-во сидений ряду: '))
distance_beetwen_rows = int(input('Введите кол-во метров между рядами: '))

for i in range(rows):
  print('=' * setats_in_one_row, end='')
  print(' ' + '*' * distance_beetwen_rows + ' ', end='')
  print('=' * setats_in_one_row)
