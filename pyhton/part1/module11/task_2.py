...
for number in range(1, number_count +1):
  print(f'Введите число №{number}: ', end='')
  input_number = float(input())
  if input_number > 0:
    input_number = math.ceil(input_number)
    print(f'x = {input_number}    log(x) = {math.log(input_number)}')
  else:
    input_number = math.floor(input_number)
    print(f'x = {input_number}    exp(x) = {math.exp(input_number)}')
  print()
